...
// source: clan/alloc/v1beta1/params.proto
...
func (*WeightedAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_a473a7738911dd5c, []int{0}
}
...
type DistributionProportions struct {
	CoreDev WeightedAddress `protobuf:"bytes,1,opt,name=core_dev,json=coreDev,proto3" json:"core_dev" yaml:"developer_rewards_receiver"`
	Dao     WeightedAddress `protobuf:"bytes,2,opt,name=dao,proto3" json:"dao" yaml:"developer_rewards_receiver"`
}
...
func (*DistributionProportions) Descriptor() ([]byte, []int) {
	return fileDescriptor_a473a7738911dd5c, []int{1}
}
...
func (m *DistributionProportions) GetCoreDev() WeightedAddress {
	if m != nil {
		return m.CoreDev
	}
...
func (m *DistributionProportions) GetDao() WeightedAddress {
	if m != nil {
		return m.Dao
	}
	return WeightedAddress{}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_a473a7738911dd5c, []int{2}
}
...
func init() {
	proto.RegisterType((*WeightedAddress)(nil), "clan.alloc.v1beta1.WeightedAddress")
	proto.RegisterType((*DistributionProportions)(nil), "clan.alloc.v1beta1.DistributionProportions")
	proto.RegisterType((*Params)(nil), "clan.alloc.v1beta1.Params")
}

func init() { proto.RegisterFile("clan/alloc/v1beta1/params.proto", fileDescriptor_a473a7738911dd5c) }

var fileDescriptor_a473a7738911dd5c = []byte{
	// 394 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *DistributionProportions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	{
		size, err := m.CoreDev.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *DistributionProportions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoreDev", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CoreDev.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
