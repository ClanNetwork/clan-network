...
export class Api extends HttpClient {
    constructor() {
       ...
       */
        this.queryClientConnections = (client_id, params = {}) => this.request({
         ...
         */
        this.queryConnection = (connection_id, params = {}) => this.request({
       ...
       */
        this.queryConnectionClientState = (connection_id, params = {}) => this.request({
       ...
       */
        this.queryConnectionConsensusState = (connection_id, revision_number, revision_height, params = {}) => this.request({
