...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryClaimEthRecord = (address: string, params: RequestParams = {}) =>
    this.request<V1Beta1QueryClaimEthRecordResponse, RpcStatus>({
  ...
  queryClaimableForAction = (
    address: string,
    action: "ActionInitialClaim" | "ActionVote" | "ActionDelegateStake" | "TBD1" | "TBD2",
